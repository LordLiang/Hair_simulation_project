...
Shader "Ciconia Studio/Effects/SSS Skin" {
    Properties {
        [Space(15)][Header(Main Properties)]
        [Space(15)]_Color ("Color", Color) = (1,1,1,1)
        _MainTex ("Albedo", 2D) = "white" {}
        [Space(15)]_SpecularColor ("Specular Color", Color) = (1,1,1,1)
        ...
        [Space(15)]_BumpMap ("Normal map", 2D) = "bump" {}
        _NormalIntensity ("Normal Intensity", Range(0, 2)) = 1
        [Space(15)]_OcclusionMap ("Ambient Occlusion map", 2D) = "white" {}
        _AoIntensity ("Ao Intensity", Range(0, 2)) = 1
        [Space(25)][Header(Skin Properties)]
        ...
        _TranslucencyIntensity ("Translucency Intensity", Range(0, 8)) = 4
        _TranslucencySpead ("Translucency Spead", Range(0, 1)) = 0
        [Space(15)]_SkinTone ("Skin Tone", Color) = (1,0.8581572,0.7921569,1)
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform float _TranslucencySpead;
            struct VertexInput {
...
/////// Diffuse:
                ...
                float3 node_4604 = (_TranslucencyColor.rgb*(_Translucencymap_var.rgb*_TranslucencyIntensity));
                float node_247 = (pow(1.0-max(0,dot(normalDirection, viewDirection)),1.0)*0.5*dot(i.normalDir,viewDirection)+0.5);
                float3 Transmissionmap = saturate((1.0-(1.0-(max(0,dot(i.normalDir,lightDirection))*attenuation))*(1.0-lerp(node_4604,(-1*saturate((1.0-(1.0-node_4604)*(1.0-node_247)))),lerp(0,2,_TranslucencySpead)))));
