...
Shader "Custom/HairStrand" {
	Properties{
        ...
        _ScatteringMap("Hair Light Scattering Map", 2D) = "black" {}
        _KDiffuse("Diffuse Term", Range(0.0, 3.0)) = 1.5
        _KR("R Term", Range(0.0, 10.0)) = 1
	...
	SubShader {
		...
		Pass {
			...
			half4 frag(PS_INPUT p) : SV_TARGET{
                ...
                return light_scattering_hair2(_ScatteringMap, light_color, ambient, light_dir, view_dir, p.world_tan, _KDiffuse, _KR);
			}
